...
public class RaymarchOctree : SceneViewFilter {
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination) {
        ...
        EffectMaterial.SetFloat("_VoxelSize", voxelSize);
        EffectMaterial.SetFloat("_ChunkSize", chunkSize);
        if (matColorRamp) {
